...
export const metadata = {
  title: "F&I Review — analyst checklist (internal preview) — Driveway Advocate",
  description:
    "Internal operations preview of the F&I Product Review reviewer workflow — mission, documents, review sequence, product checks, labels, and safe wording. Not customer advice.",
};
      ...
      <main>
        ...
        <section className="mx-auto max-w-3xl px-4 pb-6 pt-12 sm:pt-16">
          <div className="flex flex-wrap items-center gap-3">
            <span className="inline-block rounded-full bg-navy/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-navy/70">
          ...
          <h1 className="mt-4 font-serif text-4xl font-semibold leading-tight text-navy sm:text-5xl">
            F&amp;I Review — analyst checklist
          </h1>
          <div className="mt-4 rounded-xl border border-navy/15 bg-navy/[0.04] px-4 py-3">
            <p className="text-sm font-semibold text-navy/80">
              Internal operations preview — not customer advice.
            </p>
            <p className="mt-1 text-sm leading-relaxed text-navy/65">
              This page documents how a human reviewer would work the F&amp;I
              Product Review. It is an internal reference, not a deliverable and
              not legal, financial, tax, or insurance advice.
            </p>
          </div>
          <div className="mt-5">
            <Link
        ...
        <section className="mx-auto max-w-3xl space-y-8 px-4 py-10">
          ...
          <Block step={1} title="Reviewer mission">
            <div className="card">
              <p className="text-sm leading-relaxed text-navy/75">
                Give the buyer a clear, buyer-side reference point on the
                finance-office products on their deal: what to challenge, what to
                ask, and what to gather. Work strictly on the buyer&apos;s side —
                no commissions, no kickbacks, no steering toward any dealer,
                lender, finance office, warranty company, or product provider.
                Surface observations and questions; never issue a legal
                determination, and never invent a single exact price.
              </p>
            </div>
          </Block>
          ...
          <Block step={5} title="Recommendation labels">
            <div className="space-y-2.5">
              {RECOMMENDATION_LABELS.map((l) => (
                <div
                  key={l.label}
                  className="rounded-xl border border-navy/10 bg-white p-4 shadow-card"
                >
          ...
          <Block step={7} title="Phrases reviewers must not use">
            <div className="rounded-2xl border border-verdict-red/25 bg-verdict-red/5 p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-verdict-red">
                Do not say
              </p>
              <p className="mt-2 text-sm text-navy/65">
                These are training warnings. They must never appear in a
              ...
              <ul className="mt-3 space-y-2">
                {FORBIDDEN_WORDING.map((s, i) => (
                  ...
                  >
                    <span
                      className="mt-0.5 shrink-0 font-bold text-verdict-red"
                      aria-hidden
                    >
                      ✕
                    </span>
                    <span className="line-through decoration-verdict-red/40">
                      “{s}”
                    </span>
                  </li>
                ))}
