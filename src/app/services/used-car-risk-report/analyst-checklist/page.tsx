...
export const metadata = {
  title: "Used-Car Risk Report — analyst checklist (internal preview) — Driveway Advocate",
  description:
    "Internal operations preview of the Used-Car Risk Report reviewer workflow — mission, documents, review sequence, risk checks, labels, and safe wording. Not customer advice.",
};
      ...
      <main>
        ...
        <section className="mx-auto max-w-3xl px-4 pb-6 pt-12 sm:pt-16">
          ...
          <h1 className="mt-4 font-serif text-4xl font-semibold leading-tight text-navy sm:text-5xl">
            Used-Car Risk Report — analyst checklist
          </h1>
          <div className="mt-4 rounded-xl border border-navy/15 bg-navy/[0.04] px-4 py-3">
            ...
            <p className="mt-1 text-sm leading-relaxed text-navy/65">
              This documents how a human Driveway Advocate reviewer completes a
              Used-Car Risk Report. It is an internal reference, not a deliverable,
              and not legal, financial, tax, insurance, title, mechanical, or
              safety advice.
            </p>
          </div>
          <div className="mt-5">
