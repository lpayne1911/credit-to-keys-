...
import { ADDON_COPY } from "@/lib/output-contract/copy/addons";
...
function profileFor(category: AddOnCategory): {
  ...
  // Copy (reason + suggestedAction) is sourced from the shared catalog; this
  // function owns only the risk/cancellation/impact profile per category.
  const copy = ADDON_COPY[category];
  switch (category) {
    case "vsc":
      return { overpricedRisk: true, cancellationTermsNeeded: true, humanReviewRecommended: true, confidence: "medium", impactFraction: 0.3, ...copy };
    case "gap":
      return { overpricedRisk: true, cancellationTermsNeeded: true, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.4, ...copy };
    case "tire_wheel":
      return { overpricedRisk: true, cancellationTermsNeeded: true, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.5, ...copy };
    case "maintenance":
      return { overpricedRisk: false, cancellationTermsNeeded: true, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.5, ...copy };
    case "key":
      return { overpricedRisk: true, cancellationTermsNeeded: false, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.6, ...copy };
    case "ceramic":
    case "paint_fabric":
    case "appearance":
      return { overpricedRisk: true, cancellationTermsNeeded: false, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.6, ...copy };
    ...
    case "lojack_gps":
      return { overpricedRisk: true, cancellationTermsNeeded: false, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.6, ...copy };
    case "nitrogen":
      return { overpricedRisk: true, cancellationTermsNeeded: false, humanReviewRecommended: false, confidence: "medium", impactFraction: 0.8, ...copy };
    default:
      return { overpricedRisk: false, cancellationTermsNeeded: true, humanReviewRecommended: true, confidence: "low", impactFraction: 0.5, ...copy };
  }
}
